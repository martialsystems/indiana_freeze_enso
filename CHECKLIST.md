...
5. Lead with MAE in days vs the median. Per-station table. Cite `28941fb` for last year as a bar. 7/24 is not the method. Live lock `d861556`: first fall 9.96 vs 8.75 (Ridge loses); last spring 7.62 vs 8.21 (Ridge wins). Do not average it.
